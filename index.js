...
var html = `<table cellspacing="0" cellpadding="0" border="0" class="el-table__body" style="width: 706px;">
<colgroup>
    <col name="el-table_1_column_9" width="90">
    <col name="el-table_1_column_10" width="90">
    <col name="el-table_1_column_11" width="90">
    <col name="el-table_1_column_12" width="90">
    <col name="el-table_1_column_13" width="90">
    <col name="el-table_1_column_14" width="90">
    <col name="el-table_1_column_15" width="90">
    <col name="el-table_1_column_16" width="90">
</colgroup>
<tbody>
